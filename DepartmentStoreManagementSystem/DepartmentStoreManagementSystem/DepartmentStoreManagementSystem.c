    ...
    while (1)
    {
        ...
        if (ch == '\r')
        {
            if (no == 8)
            {
                ...
                else if (count == 7) changelanguage();
                else exit(0);
...
void bill()
{
    ...
    dbill();
    gotoxy(26, 15);
    printTranslateLang(Enter_finish_input);
    while (1)
    {
        gotoxy(25, 18);
        printf("                    ");
...
void edit()
{
    ...
    if (flag == 0)
    {
        ...
        while (fread(&item, sizeof(item), 1, file))
        {
            if (strcmp(item.code, x) == 0)
            {
                //textcolor(0);
                gotoxy(16, 27);
                printTranslateLang(Name);
                gotoxy(16, 28);
                printTranslateLang(Code);
                gotoxy(16, 29);
                printTranslateLang(Rate);
                gotoxy(16, 30);
                printTranslateLang(Quantity);
                gotoxy(16, 32);;
                ...
                if (toupper(_getche()) == 'Y')
                {
                    //textcolor(0);
                    gotoxy(25, 34);
                    printTranslateLang(First_edit_name);
                    gotoxy(25, 35);
                    printTranslateLang(Two_edit_code);
                    gotoxy(25, 36);
                    printTranslateLang(three_edit_rate);
                    gotoxy(25, 37);
                    printTranslateLang(Four_edit_quantity);
                    gotoxy(25, 39); ;
    ...
    {
        gotoxy(28, 30);
        printTranslateLang(item_does_not_exists);
        gotoxy(30, 32);
...
void d_all()
{
    ...
    {
        gotoxy(24, 30);
        printTranslateLang(No_article_found);
    }
    _getch();
    fclose(file);
    d_mainmenu();
